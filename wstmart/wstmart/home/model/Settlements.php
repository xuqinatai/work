    ...
    public function settlement(){
		...
		try{
            ...
            if(false !==  $result){
                 ...
                 $upSql = 'update '.$prefix.'shops set noSettledOrderNum=noSettledOrderNum-'.count($orders).',paymentMoney=paymentMoney+'.$commissionFee.',noSettledOrderFee=noSettledOrderFee-'.$commissionFee.' where shopId='.$shopId;
                 Db::execute($upSql);
            	 Db::commit();
