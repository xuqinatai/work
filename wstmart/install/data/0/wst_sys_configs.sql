...
('6', '当前系统版本号', 'wstVersion', '2.0.3_180308'),
('7', '系统版本MD5', 'wstMd5', '13b558b6a04e97739ed61d070e06aadc'),
('8', '移动端图片后缀', 'wstMobileImgSuffix', null),
('13', '商品是否需要审核', 'isGoodsVerify', '0'),
('14', '访问统计', 'visitStatistics', '&lt;script src=&quot;https://s13.cnzz.com/z_stat.php?id=1263804910&amp;web_id=1263804910&quot; language=&quot;JavaScript&quot;&gt;&lt;/script&gt;'),
('15', 'SMTP服务器', 'mailSmtp', ''),
('16', 'SMTP端口', 'mailPort', ''),
...
('45', '订单佣金比例', 'poundageRate', null),
('46', '开启QQ登录', 'isOpenQQLogin', null),
('47', 'QQ APP ID', 'qqAppId', null),
('48', 'QQ APP KEY', 'qqAppKey', null),
('49', '开启微信登录', 'isOpenWxLogin', null),
('50', '微信 APP ID', 'wxAppId', null),
('51', '微信 APP KEY', 'wxAppKey', null),
